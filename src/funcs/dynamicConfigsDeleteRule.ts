 ...
 */
export async function dynamicConfigsDeleteRule(
    client$: StatsigCore,
    request: operations.ConsoleV1DynamicConfigControllerGenRuleDeleteRequest,
    options?: RequestOptions
): Promise<
    Result<
        operations.ConsoleV1DynamicConfigControllerGenRuleDeleteResponseBody,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.ConsoleV1DynamicConfigControllerGenRuleDeleteRequest$outboundSchema.parse(
                value$
            ),
    ...
    const context = {
        operationID: "ConsoleV1DynamicConfigController.genRuleDelete",
        oAuth2Scopes: [],
    ...
    >(
        m$.json(
            200,
            operations.ConsoleV1DynamicConfigControllerGenRuleDeleteResponseBody$inboundSchema
        ),
        m$.fail(["4XX", "5XX"])
    )(response);
    if (!result$.ok) {
