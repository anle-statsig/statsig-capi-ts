 ...
 * Delete Gate Rules
 */
export async function gatesDeleteRule(
    client$: StatsigCore,
    request: operations.ConsoleV1GatesControllerGenRuleDeleteRequest,
    options?: RequestOptions
): Promise<
    Result<
        operations.ConsoleV1GatesControllerGenRuleDeleteResponseBody,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.ConsoleV1GatesControllerGenRuleDeleteRequest$outboundSchema.parse(value$),
    ...
    const context = {
        operationID: "ConsoleV1GatesController.genRuleDelete",
        oAuth2Scopes: [],
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ConsoleV1GatesControllerGenRuleDeleteResponseBody$inboundSchema),
        m$.fail(["4XX", "5XX"])
    )(response);
    if (!result$.ok) {
        return result$;
