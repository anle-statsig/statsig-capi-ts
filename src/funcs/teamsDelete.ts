...
export async function teamsDelete(
    ...
    Result<
        operations.ConsoleV1UsersControllerGenDeleteTeamResponseBody,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.ConsoleV1UsersControllerGenDeleteTeamRequest$outboundSchema.parse(value$),
    ...
    const context = {
        operationID: "ConsoleV1UsersController.genDeleteTeam",
        oAuth2Scopes: [],
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ConsoleV1UsersControllerGenDeleteTeamResponseBody$inboundSchema),
        m$.fail(["4XX", "5XX"])
    )(response);
    if (!result$.ok) {
        return result$;
