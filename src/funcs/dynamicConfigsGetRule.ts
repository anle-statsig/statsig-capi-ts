 ...
 */
export async function dynamicConfigsGetRule(
    client$: StatsigCore,
    request: operations.ConsoleV1DynamicConfigControllerGenReadRuleRequest,
    options?: RequestOptions
): Promise<
    Result<
        operations.ConsoleV1DynamicConfigControllerGenReadRuleResponseBody,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.ConsoleV1DynamicConfigControllerGenReadRuleRequest$outboundSchema.parse(
                value$
            ),
    ...
    const context = {
        operationID: "ConsoleV1DynamicConfigController.genReadRule",
        oAuth2Scopes: [],
    ...
    >(
        m$.json(
            200,
            operations.ConsoleV1DynamicConfigControllerGenReadRuleResponseBody$inboundSchema
        ),
        m$.fail(["4XX", "5XX"])
    )(response);
    if (!result$.ok) {
